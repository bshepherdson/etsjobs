(ns ets.jobs.ets2.achievements
  #_(:require
   #_[com.wsscode.pathom3.connect.built-in.resolvers :as pbir]
   #_[com.wsscode.pathom3.connect.operation :as pco]
   #_[com.wsscode.pathom3.connect.indexes :as pci]
   #_[ets.jobs.ets2.map :as map]
   #_[ets.jobs.util.interface :as util :refer [defachievement]]))

;; #_(pco/defresolver baltic-country [{c :country/id}]
...
;; 
;; #_(defachievement concrete-jungle
...
;;                                       (= "radus" sender))}))
;; 
;; #_(defachievement industry-standard
...
;; 
;; #_(defachievement exclave-transit
...
;;                                       (= "RU" dest-country))}))
;; 
;; #_(defachievement like-a-farmer
...
;;                                           recipient))}))
;; 
;; #_(defachievement turkish-delight
...
;;                                       (= origin "istanbul"))}))
;; 
;; #_(defachievement along-the-black-sea
...
;;             #{"mangalia" "constanta"}])}))
;; 
;; #_(defachievement orient-express
;;   {::pco/input [{:job/origin      [:city/id]
;;                  :job/destination [:city/id]}]}
;;   (fn [_env
;;        {{origin      :city/id} :job/origin
...
;;             ["bucuresti" "istanbul"]])}))
;; 
;; #_(defachievement lets-get-shipping
...
;; 
;; #_(defachievement taste-the-sun
...
;; 
;; ;; Scandinavia ===============================================================
;; #_(pco/defresolver scandinavian-country [{c :country/id}]
;;   {:country/scandinavian? (boolean (#{"DK" "N" "S"} c))})
;; 
;; ; TODO Test this one - no jobs found.
;; #_(defachievement volvo-trucks-lover
...
;; 
;; ; TODO Test this one - no jobs found.
;; #_(defachievement scania-trucks-lover
...
;; 
;; #_(defachievement whatever-floats-your-boat
...
;;                                  (= "F" country))}))
;; 
;; #_(defachievement check-in-check-out
...
;; #_(defachievement gas-must-flow
